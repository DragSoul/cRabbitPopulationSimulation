 ...
 * \brief Programmes pour générer des nombre pseudo-aléatoire qui suivent une probabilité donné
 * \version 0.1
...
/**
 * \fn void discDist(double rand, int  tab[], double  cumulProba[], int nbClass);
 * \brief Fonction qui générer des nombre qui suivent une probabilité donné à partir d'un nombre pseudo-aléatoire
 * 
 * \param tab tableau remplit avec fréquences
 * \param nbClass nombre de classes différentes du dans le tableau
 * \param cumulProba tableau remplit avec la probabilité cumulé pour chaque classes
 ...
 * \brief Fonction qui générer des nombre qui suivent une probabilité pour x tirage
 * 
 ...
 * \brief Fonction qui calcule la probabilité cumulé de chaque élément du tableau
 * 
 ...
 * \brief Fonction qui génére un nombre qui suit une probabilité donné à partir d'un nombre pseudo-aléatoire
 * 
 * \param nbClass nombre de classes différentes du dans le tableau
 * \param cumulProba tableau remplit avec la probabilité cumulé pour chaque classes
 * \param rand nombre pseudo-aléatoire
